...
function handleClick() {
    ...
    if (this.matches('.hasChip') && this.firstElementChild.classList.contains('blackchips')) {
        ...
        if (!squares[nextMoves[0] - 1].matches('.hasChip') && squares[nextMoves[0] - 1].matches('.black')) {
            ...
            // console.log("---");
            //cant move for now
        }else if(squares[nextMoves[0] - 1].matches('.hasChip') && !squares[nextMoves[0] - 1].firstElementChild.classList.contains('blackchips') && !squares[(nextMoves[0]+9) - 1].matches('.hasChip') && squares[(nextMoves[0]+9) - 1].matches('.black')){
            // squares[nextMoves[0] - 1].classList.toggle(this.id - 1);
            squares[(nextMoves[0]+9) - 1].classList.add('highlighted',('rmv'+(nextMoves[0] - 1)),(this.id - 1));
        ...
        if (!squares[nextMoves[1] - 1].matches('.hasChip') && squares[nextMoves[1] - 1].matches('.black')) {
            ...
            // console.log("yee");
            // console.log("----");
        }else if(squares[nextMoves[1] - 1].matches('.hasChip') && !squares[nextMoves[1] - 1].firstElementChild.classList.contains('blackchips') && !squares[(nextMoves[1]+7) - 1].matches('.hasChip') && squares[(nextMoves[1]+7) - 1].matches('.black')){
            // squares[nextMoves[0] - 1].classList.toggle(this.id - 1);
            squares[(nextMoves[1]+7) - 1].classList.add('highlighted',('rmv'+(nextMoves[1] - 1)),(this.id - 1));
    ...
    } else if (this.matches('.hasChip.black') && this.firstElementChild.classList.contains('redchips')) {
        ...
        if (!squares[nextMoves[0] - 1].matches('.hasChip') && squares[nextMoves[0] - 1].matches('.black')) {
            ...
            // console.log("---");
            //cant move for now
        }else if(squares[nextMoves[0] - 1].matches('.hasChip') && !squares[nextMoves[0] - 1].firstElementChild.classList.contains('redchips')&& !squares[(nextMoves[0]-9) - 1].matches('.hasChip') && squares[(nextMoves[0]-9) - 1].matches('.black')){
            // squares[nextMoves[0] - 1].classList.toggle(this.id - 1);
            squares[(nextMoves[0]-9) - 1].classList.add('highlighted',('rmv'+(nextMoves[0] - 1)),(this.id - 1));
            // squares[(nextMoves[0]-9) - 1].classList.toggle('highlighted');
            // squares[(nextMoves[0]-9) - 1].classList.toggle('rmv'+(nextMoves[0] - 1));
        ...
        if (!squares[nextMoves[1] - 1].matches('.hasChip') && squares[nextMoves[1] - 1].matches('.black')) {
            ...
            // console.log("yee");
            // console.log("----");
        }else if(squares[nextMoves[1] - 1].matches('.hasChip') && !squares[nextMoves[1] - 1].firstElementChild.classList.contains('redchips')&& !squares[(nextMoves[1]-7) - 1].matches('.hasChip') && squares[(nextMoves[1]-7) - 1].matches('.black')){
            // squares[nextMoves[0] - 1].classList.toggle(this.id - 1);
            squares[(nextMoves[1]-7) - 1].classList.add('highlighted',('rmv'+(nextMoves[1] - 1)),(this.id - 1));
            // squares[(nextMoves[1]-7) - 1].classList.toggle('highlighted');
            // squares[(nextMoves[1]-7) - 1].classList.toggle('rmv'+(nextMoves[1] - 1));
